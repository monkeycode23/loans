                  ...
                  <div className="mb-4">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`w-full rounded-lg border border-stroke ${!fields.username.isValid ? 'border-red text-red': ''} focus:text-black  bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary`}
                  ...
                  <div className="mb-6">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`w-full rounded-lg border border-stroke ${fields.password.error ? 'border-red text-red': ''} focus:text-black bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary`}
